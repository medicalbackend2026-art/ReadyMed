      ...
      <div className="flex items-center justify-center p-8 md:p-12">
        <div className="w-full max-w-[400px]">
          ...
          <div className="flex p-1 bg-gray-100 rounded-lg mb-8">
            <button
              ...
              className={`flex-1 py-2 text-[13px] font-semibold rounded-md transition-all ${
                role === 'employee' ? 'bg-white text-gray-900 shadow-sm' : 'text-gray-500 hover:text-gray-700'
              }`}
            >
              Professional
            </button>
            <button
              ...
              className={`flex-1 py-2 text-[13px] font-semibold rounded-md transition-all ${
                role === 'recruiter' ? 'bg-white text-gray-900 shadow-sm' : 'text-gray-500 hover:text-gray-700'
              }`}
            >
              Employer
            </button>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <Button type="submit" variant="primary" size="lg" fullWidth>Log in</Button>
          </form>

          <div className="text-center text-[13px] text-gray-500 mt-6">
            Don't have an account? <Link to={`/signup?role=${role}`} className="font-semibold text-teal-600 hover:underline">Sign up free</Link>
          </div>
        </div>
      </div>
